...
var translations = map[Language]map[string]string{
	...
	NL: {
		...
		"submit_details":      "Verzenden",
		"details_saved":       "Gegevens opgeslagen!",
	...
	FR: {
		...
		"submit_details":      "Envoyer",
		"details_saved":       "Coordonnées enregistrées\u00a0!",
	...
	ES: {
		...
		"submit_details":      "Enviar",
		"details_saved":       "¡Datos guardados!",
